...
To enable: register this script in .codex/hooks.json under PreToolUse matcher "Write|Edit":
    "command": "python \"${CODEX_PROJECT_DIR}/.codex/hooks/optional/pre_warn_win32_danger.py\""
