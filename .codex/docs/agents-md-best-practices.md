...
- **AGENTS.md** â€” coding rules, conventions, "what NOT to do", architecture pointers. Read every turn.
- **`.planning/PROJECT.md`** (GSD) â€” vision, success criteria, scope boundaries. Read when planning.
- **`IDENTITY.yaml`** â€” machine-readable identity (name, version, license, platforms). Read when releasing or generating manifests.
