...
Why not pin versions? Codex's plugin list does not
...
Usage::
    ...
    python .codex/scripts/plugins.py --pin       # write current set
    python .codex/scripts/plugins.py --check     # exit 1 on drift, print missing
    python .codex/scripts/plugins.py             # print recorded set
"""
