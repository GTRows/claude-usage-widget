---
description: "[TEMPLATE] Onboard an existing project â€” interactive runbook for IMPLEMENT.md (merge hooks, settings, AGENTS.md additions)."
---
...
- Tell the user one line about what changes (e.g. `Will copy .codex/hooks/pre_guard_security.py â€” does not exist locally.`).
...
Stage only the files you wrote â€” never use `git add -A`.
...
Do not invoke `/gtr:setup` automatically â€” it has its own confirm gates.
